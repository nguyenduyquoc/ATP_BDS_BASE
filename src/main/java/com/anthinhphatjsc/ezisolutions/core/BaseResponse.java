...
public class BaseResponse implements Serializable {
    ...
    public static <E extends BaseEntity> BaseResponse error(Object data) {
        return new BaseResponse(HttpStatus.INTERNAL_SERVER_ERROR, data);
    }

    public static <E extends BaseEntity> BaseResponse unauthorized(String message) {
        return BaseResponse.builder().setStatus(HttpStatus.UNAUTHORIZED.value()).setMessage(message);
    }

    public static <E extends BaseEntity> BaseResponse badRequest(Object data) {
    ...
    public static <E extends BaseEntity> BaseResponse throwException(Exception e) {
